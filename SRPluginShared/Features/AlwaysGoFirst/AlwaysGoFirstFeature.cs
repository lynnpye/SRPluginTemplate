...
namespace SRPlugin.Features.AlwaysGoFirst
{
    public class AlwaysGoFirstFeature : FeatureImpl
    {
        ...
        public override void PostApplyPatches()
        {
            ...
            KeyMessenger<string, global::GenericArgs>.AddKeyListener(GenericEvents.EVENT_ONCOMBATENTERED, new KeyMessenger<string, global::GenericArgs>.KeyDelegate(combatEventListener.OnCombatEntered));
            KeyMessenger<string, global::GenericArgs>.AddKeyListener(GenericEvents.EVENT_ONCOMBATEXITED, new KeyMessenger<string, global::GenericArgs>.KeyDelegate(combatEventListener.OnCombatExited));
#if SRHK
            KeyMessenger<string, global::GenericArgs>.AddKeyListener(GenericEvents.EVENT_ONCOMBATINTENSE, new KeyMessenger<string, global::GenericArgs>.KeyDelegate(combatEventListener.OnCombatIntense));
            KeyMessenger<string, global::GenericArgs>.AddKeyListener(GenericEvents.EVENT_ONCOMBATWRAPUP, new KeyMessenger<string, global::GenericArgs>.KeyDelegate(combatEventListener.OnCombatWrapup));
#endif
        }
...
#endif
            KeyMessenger<string, global::GenericArgs>.RemoveKeyListener(GenericEvents.EVENT_ONCOMBATEXITED, new KeyMessenger<string, global::GenericArgs>.KeyDelegate(combatEventListener.OnCombatExited));
            KeyMessenger<string, global::GenericArgs>.RemoveKeyListener(GenericEvents.EVENT_ONCOMBATENTERED, new KeyMessenger<string, global::GenericArgs>.KeyDelegate(combatEventListener.OnCombatEntered));
        ...
        internal class TurnDirectorPatch
        {
            ...
            {
                if (!AlwaysGoFirst || !RigRating) return;
